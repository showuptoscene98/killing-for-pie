 ...
 */
export default function SamuraiKit({ o = {}, scale = 1 }) {
  ...
  return (
    <group scale={scale}>
      ...
      {/* Huge nodachi-style katana — resting on right shoulder, tip high */}
      <group position={[0.48, 1.05, 0.08]} rotation={[0.15, 0.55, -0.85]}>
        ...
        {/* Kissaki tip taper */}
        <mesh position={[0, 1.42, 0]} rotation={[0, 0, 0]}>
